...
const DropzoneImage = React.forwardRef<HTMLInputElement, DropzoneImageProps>((props, ref) => (
    <div
        className='relative flex h-full w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-dropzoneBorder hover:bg-secondary/20'>
